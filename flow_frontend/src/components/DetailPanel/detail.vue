<template>
  <div>
    ...
    <div class="pannel" id="canvas_detailpannel" v-if="status==='canvas-selected'">
      <div class="pannel-title">画布</div>
      <div class="block-container">
        <el-checkbox @change="changeGridState" v-model="showGrid">网格对齐</el-checkbox>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    downloadFile() {
      location.href = `${configJS.BASE_API}upload_file?graphId=${this.graphId}&nodeId=${
