              ...
              <div class="card fat">
                <el-form :model="formLogin" :rules="rules" ref="formLogin">
                  ...
                  <el-form-item label="用户名" prop="username">
                    <el-input @keyup.native.enter="login" v-model="formLogin.username" clearable prefix-icon="el-icon-user-solid"></el-input>
                  </el-form-item>

                  <!-- password -->
                  <el-form-item label="密码" prop="password">
                    <el-input @keyup.native.enter="login" v-model="formLogin.password" show-password prefix-icon="el-icon-lock"></el-input>
                  </el-form-item>
